          ...
          <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li aria-current="page">
              <div className="flex items-center">
                ...
                <span className="ms-1 text-sm font-medium text-gray-500 md:ms-2">Demande de document</span>
              </div>
            </li>
      ...
      <div className="max-w-5xl mx-auto my-10">
        <div className="flex flex-col md:flex-row items-center justify-between mx-auto">
          ...
          <div className="md:w-1/2">
            <Image 
              src="https://atlantique-ibs.net/media/uploads/ck/2024/10/17/demande-de-document-100.jpg" 
              alt="Placeholder" 
        ...
        <div className="flex justify-center mt-6">
          <Link className="text-white bg-blue-700 border-2 border-transparent transition duration-700 ease-in-out hover:bg-white hover:text-blue-700 hover:border-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-base px-6 py-5 text-center" href="https://forms.office.com/r/w6AqNYYxiX">
