...
export async function migratePostsData() {
    try {
        ...
        const postsData = await db.insert(posts).values([
            // Internal posts
            { title: "Visite D'entreprise À La Société Ciment Cote D'Ivoire (SCCI)", slug: "visite-dentreprise-a-la-societe-ciment-cote-divoire-scci", thumbnail: "https://www.atlantique-ibs.net/media/uploads/vignettes/actu_vignette.png" },
            { title: "Sortie Détente À Jacqueville - Semaine D'intégration 2020", slug: "sortie-detente-a-jacqueville-semaine-dintegration-2020", thumbnail: "https://www.atlantique-ibs.net/media/uploads/vignettes/actu_vignette.png" },
            { title: "Examen TOEIC - Bachelor 2", slug: "examen-toeic-bachelor-2", thumbnail: "https://www.atlantique-ibs.net/media/uploads/vignettes/actu_vignette.png" },
            { title: "Remise De L'Homologation De Toutes Les Licences De AIBS Par Le DSUP Du Ministère De L'Enseignement Supérieur Et De La Recherche Scientifique", slug: "remise-de-lhomologation-de-toutes-les-licences-de-aibs-par-le-dsup-du-ministere-de-lenseignement-superieur-et-de-la-recherche-scientifique", thumbnail: "https://www.atlantique-ibs.net/media/uploads/vignettes/actu_vignette.png" },
            { title: "Mission aux Comores", slug: "mission-aux-comores", thumbnail: "https://www.atlantique-ibs.net/media/uploads/vignettes/462112886_869113592019335_9037365335298982038_n.jpg" },
            // External posts
