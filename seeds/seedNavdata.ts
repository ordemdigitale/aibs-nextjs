...
export async function migrateNavData() {
  try {
    ...
    await db.insert(nestedLinks).values([
      ...
      { name: "Management Opérationnel et Stratégique", slug: "/programme/management-opérationnel-et-stratégique", parentId: masterproId, order: 4 },
      ...
      { name: "Management des Systèmes d'Informations", slug: "/programme/management-des-systèmes-dinformations", parentId: masterproId, order: 7 },
      { name: "Marketing & Stratégie Digitale", slug: "/programme/marketing-stratégie-digitale", parentId: masterproId, order: 8 },
